...
class AdministrativePE(db.Model):

    __tablename__ = "tbl_administrative_performance_evaluation"
    ccn_administrative_performance_evaluation = db.Column(db.Integer, primary_key=True)
    ...
    def __repr__(self):
        return f"Administrative Performance Evaluation:{self.ccn_administrative_performance_evaluation}"

    def choice_query():
        return AdministrativePE.query
