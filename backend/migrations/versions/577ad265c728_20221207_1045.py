...
Revision ID: 577ad265c728
Revises: 8ea52319af6b
Create Date: 2022-12-07 10:45:35.511469
...
revision = '577ad265c728'
down_revision = '8ea52319af6b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('tbl_family_nucleus', sa.Column('ccn_employee', sa.Integer(), nullable=False))
    op.add_column('tbl_family_nucleus', sa.Column('ccn_auto_perceived_gender', sa.Integer(), nullable=False))
    op.create_foreign_key(None, 'tbl_family_nucleus', 'tbl_employee', ['ccn_employee'], ['ccn_employee'])
    op.create_foreign_key(None, 'tbl_family_nucleus', 'tbl_type_id', ['type_of_document'], ['ccn_type_id'])
...
def downgrade():
    ...
    op.drop_constraint(None, 'tbl_family_nucleus', type_='foreignkey')
    op.drop_constraint(None, 'tbl_family_nucleus', type_='foreignkey')
    op.drop_column('tbl_family_nucleus', 'ccn_auto_perceived_gender')
    op.drop_column('tbl_family_nucleus', 'ccn_employee')
    # ### end Alembic commands ###
