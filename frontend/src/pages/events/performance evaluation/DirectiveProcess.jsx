...
function ImmediatiBossFormDPE({ ccn_performance_evaluation }) {
    ...
    const onSubmit = (data) => {
        const sedData = async () => {
            ...
            const response = await axios
                .put(
                    `${import.meta.env.VITE_API_ADDRESS}first_section_dpe/${ccn_performance_evaluation}`,
                    body,
...
function EmployeeAnswerDPE({ ccn_performance_evaluation }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = (data) => {
        const sedData = async () => {
            ...
            const response = await axios
                .put(
                    `${import.meta.env.VITE_API_ADDRESS}second_section_dpe/${ccn_performance_evaluation}`,
                    body,
                    { header: { "Access-Control-Allow-Origin": "*" } }
                )
                .then((response) => {
...
function ActionPlanDPE({ ccn_performance_evaluation }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const getDetail = async () => {
        try {
            const respPerformanceEvaluation = await axios(
                `${import.meta.env.VITE_API_ADDRESS}directive_performance_evaluation_detail/${ccn_performance_evaluation}`
            );
            setDetailPerformanceEvaluation(respPerformanceEvaluation.data.DirectivePE);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const onSubmit = (data) => {
        const sedData = async () => {
            const body = {
                ...
                second_accion_plan_date: data.second_accion_plan_date ? data.second_accion_plan_date : "",
                third_accion_plan: data.third_accion_plan ? data.third_accion_plan : "",
                third_accion_plan_date: data.third_accion_plan_date ? data.third_accion_plan_date : "",
            ...
            const response = await axios
                .put(
                    `${import.meta.env.VITE_API_ADDRESS}third_section_dpe/${ccn_performance_evaluation}`,
                    body,
                    { header: { "Access-Control-Allow-Origin": "*" } }
                )
                .then((response) => {
        ...
        <div className="bg-white rounded-lg h-[70vh]">
            <div className="mx-auto p-5">
                <div className="lg:grid lg:grid-cols-2 text-start sm:grid sm:grid-cols-1 my-3">
                    <form onSubmit={handleSubmit(onSubmit)} className="justify-self-start mx-auto">
                        <h3 className="text-[20px] py-[25px]"><strong>4. Plan de Accion</strong></h3>
...
function ManagerAprovalDPE({ ccn_performance_evaluation }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const getDetailData = async () => {
        try {
            ...
            setDetailPerformanceEvaluation(respDetailPerformanceEvaluation.data.DirectivePE);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const onSubmit = (data) => {
        const sedData = async () => {
            if (managerApproval === null) {
                ...
                const urlAddress = `${import.meta.env.VITE_API_ADDRESS}four_section_dpe/${ccn_performance_evaluation}`
